...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch(`war-data-base.json?v=${new Date().getTime()}`)
        ...
        .then(data => {
            ...
            data.rows.sort((a, b) => {
                let scoreA = (a[2] > 0 && a[3] > 0) ? (a[3] / a[2]) + (a[2] * 0.05) : 0; // Use 0 para jogadores com PTs ou Guerras = 0
                let scoreB = (b[2] > 0 && b[3] > 0) ? (b[3] / b[2]) + (b[2] * 0.05) : 0; // Use 0 para jogadores com PTs ou Guerras = 0
